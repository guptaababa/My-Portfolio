...
const Experiences = () => {
  const experiences = [
    {
      ...
      description: "Working as a Data Scientist for the client ICICI Bank.",
  ...
  return (
    <animated.section ref={ref} id="experiences" className="py-20">
      <h2 className="text-4xl sm:text-5xl font-bold text-center mb-12 text-violet-400">
        My Experiences
      </h2>
